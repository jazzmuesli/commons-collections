...
public class PredicateUtils_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.commons.collections4.Transformer", false, PredicateUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.collections4.functors.AnyPredicate", false, PredicateUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.collections4.functors.FalsePredicate", false, PredicateUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.collections4.functors.IdentityPredicate", false, PredicateUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.collections4.functors.NotNullPredicate", false, PredicateUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.collections4.functors.NotPredicate", false, PredicateUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.collections4.functors.NullIsTruePredicate", false, PredicateUtils_ESTest_scaffolding.class.getClassLoader()));
  }
