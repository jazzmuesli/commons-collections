...
public class CompositeMap_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.Comparable", false, CompositeMap_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("java.util.function.Function", false, CompositeMap_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.collections4.map.EntrySetToMapIteratorAdapter", false, CompositeMap_ESTest_scaffolding.class.getClassLoader()));
  }
